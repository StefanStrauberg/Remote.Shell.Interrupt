...
export default function ClientListFilter({
  ...
  const handleReset = () => {
    ...
    setWorking(true);
    setAntiDDOS(false);
    onApplyFilters(DEFAULT_CLIENT_FILTERS);
    onResetFilters?.();
  };

  const hasActiveFilters =
    name.trim() !== "" || nrDogovor.trim() !== "" || !working || antiDDOS;
