...
export default function NetworkDeviceListFilter({
  ...
  const handleApply = () => {
    const normalizedName = NetworkDeviceName.trim();
    ...
    const filters: FilterDescriptor[] = [
      ...(normalizedName !== ""
        ...
        : []),
      ...(normalizedHost !== ""
        ? [createFilter("Host", FilterOperator.Equals, normalizedHost)]
        : []),
      ...(typeOfNetworkDevice !== ""
        ? [
            createFilter(
  ...
  const handleReset = () => {
    ...
    onApplyFilters(DEFAULT_NETWORK_DEVICE_FILTERS);
    onResetFilters?.();
  };
