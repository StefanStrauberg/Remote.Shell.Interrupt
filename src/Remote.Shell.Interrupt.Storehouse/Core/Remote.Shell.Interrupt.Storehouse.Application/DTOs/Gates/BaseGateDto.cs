...
/// <see cref="IRegister"/>: nothing ever maps a bare <see cref="BaseGateDTO"/>, and each
/// derived DTO (<see cref="CreateGateDTO"/>, <see cref="GateDTO"/>, <see cref="UpdateGateDTO"/>)
/// registers its own complete Mapster map anyway - Name/Community are mapped by
/// convention and TypeOfNetworkDevice is converted string↔enum by Mapster's built-in
